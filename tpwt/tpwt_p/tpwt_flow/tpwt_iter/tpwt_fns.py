...
def write_period_eqlistper_temp(per, vel, snr, dist, nsta, smooth, damping,
    eqlistper, temp, sens_dat: str, sec_snr_dis: str):
    """
...
def rdsetupsimul_phamp_from_earthquake_TPWT(per, vel, snr, dist, nsta, smooth, damping,
    eqlistper: str, sens_dat: str, sec_snr_dis: str, bin_from='./'):
    """
    rdsetupsimul phamp
    """
    # write temp file
    ...
    write_period_eqlistper_temp(per, vel, snr, dist, nsta, smooth, damping,
        eqlistper, temp, sens_dat, sec_snr_dis)

    # rdsetupsimul_phamp_from_earthquake
    rdsetupsimul_phamp = get_binuse('rdsetupsimul_phamp_from_earthquake', bin_from=bin_from)
...
def find_bad_kern(kern, *, per, ampcut, tcut, stacut, tevtrmscut=None, ampevtrmscut=None, bin_from='./'):
    """
